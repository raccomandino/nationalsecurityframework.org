...
.gittu-tobuy {
  ...
  .whitepaper-btn {
    ...
    line-height: 26px;
    text-transform: uppercase;
    color: ${({ theme }) => theme.colors.whtie};
    display: flex;
    align-items: center;
    justify-content: center;
    gap: 10px;
  ...
  .token-info-list {
    ...
    li {
      ...
      flex-wrap: wrap;
      padding-bottom: 11px;
      border-bottom: 1px solid ${({ theme }) => theme.colors.black}1a;
    }
  ...
  .presale-item {
    ...
    input {
      width: 100%;
      padding: 16px;
      background: ${({ theme }) => theme.colors.black}0d;
      border: 2px solid ${({ theme }) => theme.colors.black}1a;
      border-radius: 10px;
      font-weight: 600;
      font-size: 18px;
      line-height: 18px;
